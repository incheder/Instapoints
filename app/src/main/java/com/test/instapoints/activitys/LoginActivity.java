...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnClickListener {
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            saveCredentials(acct.getDisplayName(),acct.getEmail(),acct.getPhotoUrl());
    ...
    private void saveCredentials(String name,String email, Uri avatarUri){
        ...
        editor.putString(getString(R.string.credentials_name),name);
        editor.putString(getString(R.string.credentials_email),email);
        editor.putString(getString(R.string.avatarUri),avatarUri.toString());
