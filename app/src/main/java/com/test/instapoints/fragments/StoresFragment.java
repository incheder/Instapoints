 ...
 * {@link OnStoresFragmentInteractionListener} interface
...
public class StoresFragment extends Fragment implements OnMapReadyCallback {
    ...
    private OnStoresFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onStoresFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnStoresFragmentInteractionListener) {
            mListener = (OnStoresFragmentInteractionListener) context;
        } else {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(19.0433400,-98.2019300);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Puebla"));
    ...
    public interface OnStoresFragmentInteractionListener {
        ...
        void onStoresFragmentInteraction(Uri uri);
    }
}
